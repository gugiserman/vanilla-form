...
var _getRandomId = __webpack_require__(301);
...
var _transformFields = __webpack_require__(302);

Object.defineProperty(exports, 'transformFields', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_transformFields).default;
  }
});

var _validateFormData = __webpack_require__(303);
...
var _mock = __webpack_require__(306);

var _mock2 = _interopRequireDefault(_mock);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var form = new _Form2.default(_mock2.default);
...
var _fields = __webpack_require__(304);
...
var Form = function () {
  function Form() {
    ...
    this.id = data.id || (0, _utils.getRandomId)();
    this.fields = (0, _utils.transformFields)(data.fields);

    this.element = this.renderForm(data);
    this.renderFields();
  }

  Form.prototype.renderForm = function renderForm(_ref) {
    var _ref$id = _ref.id,
        id = _ref$id === undefined ? this.id : _ref$id,
        _ref$name = _ref.name,
        name = _ref$name === undefined ? this.id : _ref$name;
  ...
  Form.prototype.renderFields = function renderFields() {
    ...
    var children = this.fields.map(function (_ref2) {
      var type = _ref2.type,
          meta = _ref2.meta;

      switch (type) {
        case 'input':
          return new _fields.Input(meta);
        default:
          return null;
      }
    ...
    children.forEach(function (child) {
      return _this.element.appendChild(child.element);
    });
  };
...
var transformFields = function transformFields() {
  var object = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var keyName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'type';
  var valueName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'meta';
...
exports.default = transformFields;
...
var validateFormContainer = function validateFormContainer() {
  var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' && _typeof(data.fields) === 'object' && Object.keys(data.fields).length > 0) {
    return true;
  }
...
exports.default = validateFormContainer;
...
var Input = function () {
  function Input() {
    ...
    this.metadata = (0, _utils.transformFields)(data, 'attr', 'value');
  ...
  Input.prototype.render = function render() {
    ...
    this.metadata.map(function (_ref) {
      var attr = _ref.attr,
          value = _ref.value;
      return input.setAttribute(attr, value);
    });

...
/******/ 	__webpack_require__.p = "/vanilla-form";
/******/
...
var _arrayFromObject = __webpack_require__(302);
...
var _getRandomId = __webpack_require__(304);

Object.defineProperty(exports, 'getRandomId', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_getRandomId).default;
  }
});

var _mergeSavedData = __webpack_require__(305);

Object.defineProperty(exports, 'mergeSavedData', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_mergeSavedData).default;
  }
});

var _sanitizeEventName = __webpack_require__(306);

Object.defineProperty(exports, 'sanitizeEventName', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_sanitizeEventName).default;
  }
});

var _validateFormData = __webpack_require__(307);

Object.defineProperty(exports, 'validateFormData', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_validateFormData).default;
  }
});
...
var _mock = __webpack_require__(315);
...
var eventHandlers = {
  onInputChange: function onInputChange(event, component) {
    console.log('input change', event.target.value, component);
  },
  onAddressSelect: function onAddressSelect(event, component) {
    console.log('address input change', event.target.value, component);
  },
  onFileSelect: function onFileSelect(event, component) {
    console.log('file select', event.target.value, component.element.files[0]);
  },
  onButtonClick: function onButtonClick(event, component) {
  ...
  onSubmit: function onSubmit(event, formData, form) {
    event.preventDefault();
...
var form = new _Form2.default((0, _utils.mergeSavedData)(_mock2.default), eventHandlers);
...
var _fields = __webpack_require__(308);
...
var Form = function () {
  function Form() {
    ...
    this.handleFormSubmit = function (event) {
      var onSubmit = _this.eventHandlers.onSubmit;
      ...
      return onSubmit(event, _this.getFormData(), _this);
    };

    (0, _utils.validateFormData)(data);

    var props = data.props;


    this.id = props.id || (0, _utils.getRandomId)();
    this.props = props;
    this.metadata = (0, _utils.arrayFromObject)(props);
  ...
  Form.prototype.renderForm = function renderForm() {
    var form = document.createElement('form');

    this.metadata.map(function (_ref) {
      var attr = _ref.attr,
          value = _ref.value;
      return form.setAttribute(attr, value);
    });
  ...
  Form.prototype.renderFields = function renderFields() {
    var _this2 = this;

    var _eventHandlers = this.eventHandlers,
        onInputChange = _eventHandlers.onInputChange,
        onFileSelect = _eventHandlers.onFileSelect,
        onAddressSelect = _eventHandlers.onAddressSelect,
        onButtonClick = _eventHandlers.onButtonClick;


    var children = this.fields.map(function (field) {
      switch (field.component) {
        case 'address':
          return new _fields.AddressInput(field, {
            change: onAddressSelect
          });
        case 'input':
          return new _fields.TextInput(field, {
            keyUp: onInputChange
          });
        case 'upload':
          return new _fields.Upload(field, {
            change: onFileSelect
          });
        case 'button':
          if (field.props.type === 'submit') {
            return new _fields.Button(field);
          }
      ...
      return child && child.element;
    });

    children.forEach(function (child) {
      return _this2.element.appendChild(child.element);
    });
  };
...
var arrayFromObject = function arrayFromObject() {
  var object = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var keyName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'attr';
  ...
  for (var _iterator = entries, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
    ...
    result.push((_result$push = {}, _result$push[keyName] = key, _result$push[valueName] = value, _result$push));
  }
...
var mergeSavedData = function mergeSavedData(data) {
  var currentData = localStorage.getItem('vanilla_form_data');
  ...
  if (currentData.fields && currentData.fields.length) {
    data.fields = data.fields.map(function (field) {
      var savedField = currentData.fields.find(function (someField) {
        return someField.component === field.component && someField.props.id === field.props.id;
      });

      return _extends({}, field, savedField);
    });
  }
...
exports.default = mergeSavedData;
...
var sanitizeEventName = function sanitizeEventName(name) {
...
exports.default = sanitizeEventName;
...
var validateFormData = function validateFormData() {
  ...
  if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' && Array.isArray(data.fields)) {
    return true;
  }
...
var _TextInput = __webpack_require__(309);
...
var _AddressInput = __webpack_require__(312);
...
var _commons = __webpack_require__(48);
...
var getValidatorTemplate = function getValidatorTemplate() {
  var param = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'type';
  return {
    param: param
  };
};
...
var TextInput = function (_Input) {
  ...
  function TextInput(data, eventHandlers) {
    _classCallCheck(this, TextInput);

    var _this = _possibleConstructorReturn(this, _Input.call(this, data, eventHandlers));

    _this.bindMask();
    _this.bindValueUpdate();
    return _this;
  }

  TextInput.prototype.bindMask = function bindMask() {
    var _this2 = this;
    ...
    var chars = mask.split('').map(function (char) {
      var type = typeof char === 'undefined' ? 'undefined' : _typeof(char);
    ...
    this.inputElement.addEventListener('keydown', function (event) {
      ...
      var formatter = _this2.formatter[value.length];

      if (!formatter) {
        return false;
      }

      var param = formatter.param;
      ...
      switch (param) {
        case 'type':
          ...
          if (type === (typeof key === 'undefined' ? 'undefined' : _typeof(key))) {
            isValid = true;
          }
        ...
        case 'char':
          ...
          if (!isValid && key.length === 1) {
            event.preventDefault();
            var valueAsChars = value.split('').slice(0, value.length);
            valueAsChars.push(char);
            valueAsChars.push(key);

            _this2.inputElement.value = valueAsChars.join('');
          }
  ...
  TextInput.prototype.bindValueUpdate = function bindValueUpdate() {
    var _this3 = this;

    this.inputElement.addEventListener('keyup', function (event) {
      _this3.props.value = event.target.value;
    });
  };
...
var Component = function () {
  ...
  Component.prototype.render = function render() {
    ...
    this.metadata.map(function (_ref2) {
      var attr = _ref2.attr,
          value = _ref2.value;
  ...
  Component.prototype.bindEventListeners = function bindEventListeners() {
    var _this = this;
    ...
    var entries = Object.entries(this.eventHandlers);
    ...
    var _loop = function _loop() {
      ...
      var name = (0, _utils.sanitizeEventName)(entry[0]);
      var handler = entry[1];


      _this.element.addEventListener(name.toLowerCase(), function (event) {
...
var Input = function (_Component) {
  ...
  function Input(data, eventHandlers) {
    _classCallCheck(this, Input);

    var _this = _possibleConstructorReturn(this, _Component.call(this, data, eventHandlers));

    _this.inputElement = _this.element;
    _this.renderLabel();
    return _this;
  }
...
var PlacesService = window.google.maps.places.PlacesService;

var AddressInput = function (_Input) {
  _inherits(AddressInput, _Input);

  function AddressInput(data, eventHandlers) {
    _classCallCheck(this, AddressInput);

    var _this = _possibleConstructorReturn(this, _Input.call(this, data, eventHandlers));

    _this.handleChildrenMousedown = function () {
      _this._isInteractingWithin = true;
    };

    _this.handleInputBlur = function () {
      if (_this._isInteractingWithin) {
        return false;
      }

      _this._isInteractingWithin = false;
      _this.closeResults();
    };
    ...
    _this.handleInputChange = function (event) {
      ...
      _this.placesService.textSearch({ query: value }, function (results) {
        _this.isLoading = false;
        _this.renderPlaces(results);
      });
    };

    _this._isLoading = false;
    _this._isInteractingWithin = false;
    _this.placesService = new PlacesService(_this.inputElement);

    _this.bindPlaceSearch();
    return _this;
  }

  AddressInput.prototype.renderLoadingFeedback = function renderLoadingFeedback() {
  ...
  AddressInput.prototype.removeLoadingFeedback = function removeLoadingFeedback() {
  ...
  AddressInput.prototype.closeResults = function closeResults() {
  ...
  AddressInput.prototype.handlePlaceClick = function handlePlaceClick(event, address) {
    this.inputElement.value = address;
    this.props.value = address;
    this.closeResults();
  };

  AddressInput.prototype.renderPlace = function renderPlace() {
    var place = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    var _this2 = this;

    var index = arguments[1];
    var listElement = arguments[2];
    ...
    container.addEventListener('click', function (event) {
      return _this2.handlePlaceClick(event, formattedAddress);
    });
  ...
  AddressInput.prototype.renderPlaces = function renderPlaces() {
    var _this3 = this;
    ...
    places.slice(0, 5).map(function (place, index) {
      return _this3.renderPlace(place, index, list);
    });
  ...
  AddressInput.prototype.bindPlaceSearch = function bindPlaceSearch() {
    this.inputElement.className += ' address-input';
    this.inputElement.addEventListener('blur', this.handleInputBlur);
    this.inputElement.addEventListener('keyup', (0, _utils.debounce)(this.handleInputChange, 200));
  };
...
var Upload = function (_Component) {
  ...
  function Upload(data, eventHandlers) {
  ...
  Upload.prototype.bindValueUpdate = function bindValueUpdate() {
    var _this2 = this;

    this.element.addEventListener('change', function (event) {
      _this2.props.value = event.target.files[0];
    });
  };
...
var Button = function (_Component) {
  ...
  function Button(data, eventHandlers) {
  ...
  Button.prototype.renderLabel = function renderLabel() {
    var label = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.label;
...
// module
exports.push([module.i, "body {\n  background-color: #f4f4f4;\n  font-family: arial;\n  text-align: center;\n  color: #444;\n}\n#app-container {\n  width: 100%;\n  text-align: center;\n}\n.form {\n  display: block;\n  background-color: #fff;\n  border-radius: 10px;\n  padding: 20px;\n  max-width: 600px;\n  margin: auto;\n  text-align: center;\n}\n.form * {\n  display: block;\n  margin: auto;\n  margin-bottom: 15px;\n}\n.input-container {\n  position: relative;\n}\n.input {\n  width: 90%;\n  border-width: 0 0 1px 0;\n  border-color: #ddd;\n  font-size: 14px;\n  color: #444;\n  padding: 17px 10px 8px 10px;\n}\n.input::placeholder {\n  color: transparent;\n  font-size: 0;\n}\n.input-label {\n  position: absolute;\n  color: #999;\n  margin-top: -42px;\n  margin-left: 30px;\n  font-size: 14px;\n  transition: 0.1s ease all;\n}\n.input:not(:placeholder-shown):valid ~ .input-label {\n  color: #20c7b1;\n}\n.input:not(:placeholder-shown):invalid ~ .input-label {\n  color: red;\n}\n.input:not(:placeholder-shown) ~ .input-label,\n.input:focus ~ .input-label {\n  font-size: 10px;\n  margin-top: -57px;\n}\n.input-loading-feedback {\n  position: absolute;\n  color: #ddd;\n  top: 0;\n  right: 30px;\n}\n.address-results-container {\n  width: 90%;\n  margin-top: -15px;\n  padding: 20px;\n  padding-bottom: 5px;\n  border-radius: 0 0 10px 10px;\n  border: 1px solid #ddd;\n  border-width: 0 1px 1px 1px;\n  font-size: 12px;\n  text-align: left;\n  box-sizing: border-box;\n}\n.address-results {\n  padding: 0;\n}\n.address-results-item {\n  padding: 0;\n  border-bottom: 1px solid #f4f4f4;\n}\n.address-results-item:last-child {\n  border: 0;\n}\n.address-results-item a {\n  text-decoration: none;\n  color: #444;\n  margin-bottom: 12px;\n}\n.address-results-item a:hover {\n  color: #20c7b1;\n}\n.button {\n  width: 100%;\n  padding: 12px 0;\n  background-color: #fff;\n  color: #20c7b1;\n  font-size: 14px;\n  border: 1px solid #ddd;\n  border-radius: 45px;\n  cursor: pointer;\n  transition: 0.1s ease all;\n}\n.button:hover {\n  transform: scale(0.95);\n}\n.button:focus {\n  opacity: .7;\n}\n.button.active {\n  color: #f4f4f4;\n  background-color: #20c7b1;\n}\n", ""]);
